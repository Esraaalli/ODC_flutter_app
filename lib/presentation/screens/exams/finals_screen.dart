  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
          itemCount: finalsList.length,
          itemBuilder: (context, index) => LecturesCardItem(
                title: finalsList[index].examSubject,
                date: finalsList[index].examDate,
                endTime: finalsList[index].examEndTime,
                startTime: finalsList[index].examStartTime,
              )),
    );
  }
}
